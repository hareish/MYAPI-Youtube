...
CREATE TABLE IF NOT EXISTS `mydb`.`video` (
  ...
  `format_1080` VARCHAR(45) NULL,
  `format_720` VARCHAR(45) NULL,
  `format_480` VARCHAR(45) NULL,
  `format_360` VARCHAR(45) NULL,
  `format_240` VARCHAR(45) NULL,
  `format_144` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
